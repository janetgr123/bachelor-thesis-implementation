...
public class DpVolumeHidingTrapdoor2 {
    ...
    public static class Constants {
        final String folder = "src/test/resources/benchmark/dpVolumeHiding/sequential";
        final String method = "trapdoor2";
    }
    ...
    public static class ResultPrinter {
        ...
        public void printToCsv(
            ...
            printer.printRecord(col1, col2, col3, col4, col5, col6, col7, col8, col9);
        }
    ...
    public static class RangeSchemeState {
        ...
        public void sampleRange(
            ...
            final var token2 = parameters.rangeBRCScheme.trapdoor(range, ciphertexts);
            printer.printToCsv(
                    "range",
                    range.getMinimum(),
                    range.getMaximum(),
    ...
    @Benchmark
    public List<SearchToken> trapdoor2(
            @NotNull Parameters rangeSchemeParameters, @NotNull RangeSchemeState state)
            throws GeneralSecurityException, IOException {
        return rangeSchemeParameters.rangeBRCScheme.trapdoor(state.range, state.ciphertexts);
    }
}
